    ...
    <svg width="1em" height="1em" viewBox="0 -4 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier">
            <g clip-path="url(#clip0_503_3720)">
                ...
                <mask id="mask0_503_3720" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="28"
                    height="20">
                    <rect x="0.25" y="0.25" width="27.5" height="19.5" rx="1.75" fill="white" stroke="white"
                        stroke-width="0.5"></rect>
                </mask>
                <g mask="url(#mask0_503_3720)">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 6.66667H28V0H0V6.66667Z" fill="#04AAC8"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 20H28V13.3333H0V20Z" fill="#23C840"></path>
